...
#SBATCH --array=0-550
#SBATCH --output=/projects/immunestatus/vdjdb/tcrempnet_logs_trb/%x_%A_%a.log
...
# =========================
STATUS_LOG="/projects/immunestatus/vdjdb/tcrempnet_logs_trb/grid_status.log"
...
BACKGROUND="/projects/immunestatus/vdjdb/airr_format/${CHAIN,,}_background.tsv"
BG_EMB="/projects/immunestatus/vdjdb/tcremp/${CHAIN,,}_background_embeddings.parquet"

LOGDIR="/projects/immunestatus/vdjdb/tcrempnet_logs_trb"
mkdir -p "${LOGDIR}"
...
# =========================
SAMPLE="/projects/immunestatus/vdjdb/airr_format/${CHAIN,,}_vdjdb_${EPITOPE}.tsv"
SAMPLE_EMB="/projects/immunestatus/vdjdb/tcremp/${CHAIN,,}_vdjdb_${EPITOPE}_embeddings.parquet"

# =========================
# Output directory (unique per config)
# =========================
BASE_OUT_PREFIX="/projects/immunestatus/vdjdb/tcrempnet_${EPITOPE}_${CHAIN,,}"
